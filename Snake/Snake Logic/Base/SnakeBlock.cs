...
namespace Snake.Logic.Base
{
    ...
    public partial class SnakeBlock
    {
        ...
        public GraphicGamePlataform Plataform { get; private set; }
        /// <summary>
        ...
        public SnakeBlock(in GraphicGamePlataform plataform, Point location, Direction direction, List<Turning> turnings, int index)
        {
            Location = location;
            Direction = direction;
        ...
        /// <param name="direction">Direção inicial.</param>
        /// <param name="index">Numéro no índicie.</param>
        public SnakeBlock(in GraphicGamePlataform plataform, Point location, Direction direction, int index)
        {
            Location = location;
            Direction = direction;
            Index = index;
